...
- **On Windows:**  
  Find the `.exe` file you downloaded and double-click it. A setup window will appear. Follow the instructions on your screen by clicking "Next" and then "Install". When done, click "Finish".
...
2. A browser window will open asking for permission to access your GitHub data.
3. Follow the instructions to log in and allow skills to link with your account.
